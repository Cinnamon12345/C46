...
function setup() {
  ...
  wall1 = createSprite(200, 50, 20, 100);
  wall1.shapeColor = 'red';
  wall1.addImage(bush);
  wall1.scale = 0.2;

  wall2 = createSprite(50, 630, 100, 20);
  ...
  wall4 = createSprite(350, 200, 100, 20);
  ...
  wall7 = createSprite(240, 230, 20, 170);
  wall7.shapeColor = 'purple';
  wall7.addImage(deer);
  wall7.scale = 0.2;

  wall8 = createSprite(350, 300, 20, 140);
  wall8.shapeColor = 'orange';
  wall8.addImage(bush);
  wall8.scale = 0.2;

  wall9 = createSprite(150, 100, 200, 20);
  ...
  wall11 = createSprite(400, 300, 20, 100);
  ...
  wall13 = createSprite(426, 455, 20, 100);
  ...
  wall17 = createSprite(610, 230, 20, 170);
